...
const Sidebar = ({ children }) => {
    ...
    return (
        <>
            <nav className="bg-white px-8 py-1 flex flex-row items-center justify-between h-12 w-full sticky top-0">
            ...
            <div className="flex flex-row space-x-4 font-roboto">
                {
                    !toggleMenu &&
                    <div className="bg-white sticky top-12 h-full w-64 py-4">
                        <Link 
                ...
                <div className=" bg-gray-100 overflow-y-auto border-t-2 h-screen w-full">
                    {children}
                </div>
            </div>
        </>
